...
//    @ColumnInfo(name = "time_of_reminder") val timeOfReminder: LocalTime,
//    @ColumnInfo(name = "days_of_reminder") val days: String,
//    @ColumnInfo(name = "frequency") val timeBetweenReminders: Int, //in weeks

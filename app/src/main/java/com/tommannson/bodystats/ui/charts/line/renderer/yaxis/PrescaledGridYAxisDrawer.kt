...
class PrescaledGridYAxisDrawer(
    ...
    override fun drawAxisLabels(
        ...
        for (i in 0..labelCount) {
            ...
            if (maxValue == minValue) {
                value =
                    lineChartData.minY + (i * (lineChartData.maxY - lineChartData.minY) / labelCount)
            }
        ...
        for (i in 0..labelCount) {
            ...
            canvas.nativeCanvas.drawLine(
                drawableArea.width,
                y,
                canvas.nativeCanvas.width.toFloat() - drawableArea.width - 14.dp.toPx(),
                y,
                textPaint
            )
        }
